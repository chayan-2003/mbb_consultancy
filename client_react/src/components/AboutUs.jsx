...
const AboutUs = () => {
  return (
    <div className="flex justify-between items-center p-8 bg-slate-300 relative  bottom-1 shadow-xl ">
      <div className="flex flex-col justify-center items-start">
        <h2 className="text-4xl font-bold uppercase mb-4 relative bottom-10  font-serif">ABOUT US</h2>
        <div class=" font-medium text-xl  ">
        <p>
          <ul>MBB Consultancy is a leading engineering firm committed to excellence in providing</ul>
